...
def sidebar_menu():
    ...
    opciones_principales = ["Home", "Cloud", "Programacion", "Utilidades"]
    ...
    if menu != "Home":
        st.sidebar.markdown("<h3 style='margin-top: 20px;'>Cursos</h3>", unsafe_allow_html=True)
        ...
        if os.path.exists(carpeta_base):
            ...
            st.sidebar.markdown("<h3 style='margin-top: 20px;'>Clase</h3>", unsafe_allow_html=True)
